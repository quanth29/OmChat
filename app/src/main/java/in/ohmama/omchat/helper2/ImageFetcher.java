...
package in.ohmama.omchat.helper2;
...
import in.ohmama.omchat.xmpp.XmppTool;
...
//        }
        ...
        try {
            card.load(XmppConnectHelper.getInstance().getConnection(), XmppTool.getFullUsername(data));
            if (card.getAvatar() != null) {
                LogUtil.i("load from net",data);
